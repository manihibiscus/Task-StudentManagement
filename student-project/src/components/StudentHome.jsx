...
export const StudentHome = () => {
    // const leaveStatus = useSelector((state)=>state.leaveReq.getLeaveRequestDetails);
  ...
  useEffect(() => {
    ...
    // const filterStatus = leaveStatus.filter((data)=>{
    //     return data.reqStuEmail === loggedUser.userId;
    // });
    // alert(filterStatus[0].reqStuEmail);
    // }
