...
export const Header = () => {
  ...
  return (
        ...
        <a href="" id="brand" className="flex gap-4 item-center">
            ...
            {!value && (
                <div id="nav-menu" className="hidden md:flex gap-12 text-lg">
                    ...
                    <a className="font-medium hover:bg-pink-200 px-2 py-1 hover:text-pink-700 rounded-md"><Link to="/contact">Contact Us</Link></a>
    ...
    <div className={`absolute right-1 bg-white w-[200px] h-[200px] text-lg rounded-md ${data.menuToggle ? 'visible' : 'invisible'} `}>
        ...
        <a className="font-medium hover:text-pink-600 hover:bg-blue-200 block text-center p-2 border-blue-300 border-2" ><Link to="/contact" >Contact Us</Link></a>
